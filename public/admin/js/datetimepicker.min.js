    ...
    var c = function (c, d) {
        var e,
            ...
            M = function (a, b) {
                return a.isValid()
                    ? d.disabledDates && K(a) && "M" !== b
                        ...
                        ? !1
                        : "d" === b &&
                          -1 !== d.daysOfWeekDisabled.indexOf(a.day())
                        ? !1
                        : !0
                    : !1;
            },
            ...
            Z = {
                ...
                selectMonth: function (b) {
                    ...
                    l.month(c),
                        i === p
                            ? (W(k.clone().year(l.year()).month(l.month())),
                              d.inline || X())
                            : (I(-1), Q());
                },
            ...
            $ = function (b) {
                return a(b.currentTarget).is(".disabled")
                    ? !1
                    : (Z[a(b.currentTarget).data("action")].apply(j, arguments),
                      !1);
            },
            _ = function () {
                var c,
            ...
            ib = function () {
                ...
                (g = a.replace(
                    ...
                    (f =
                        g.toLowerCase().indexOf("a") < 1 && g.indexOf("h") < 1),
                    x("y") && (p = 2),
                    x("M") && (p = 1),
                    x("d") && (p = 0),
                    (i = Math.max(p, i)),
        ...
        if (
            ...
            (j.viewMode = function (a) {
                ...
                return (
                    (d.viewMode = a), (i = Math.max(r.indexOf(a), p)), I(), j
                );
            }),
