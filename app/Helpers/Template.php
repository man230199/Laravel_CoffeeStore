...
class Template
{
    ...
    { // $currentFilterStatus active inactive all
        $xhtml = null;
        $tmplStatus = Config::get('coffee.template.status');
    ...
    {
        $xhtml = null;
        $tmplField         = Config::get('coffee.template.search');
        $fieldInController = Config::get('coffee.config.search');
    ...
    public static function showItemHistory($by, $time)
    {
        $xhtml = sprintf(
            ...
            $by,
            date(Config::get('coffee.format.short_time'), strtotime($time))
        );
        return $xhtml;
    }
    ...
    {
        $tmplIsHome = Config::get('coffee.template.is_home');
    ...
    public static function showItemSelect($controllerName, $id, $displayValue, $fieldName)
    {
        ...
        $tmplDisplay = Config::get('coffee.template.' . $fieldName);
    ...
    public static function showCustomItemSelect($controllerName, $id, $displayValue, $fieldName,$valArr,$name = 'select_change_attr')
    {
        $link          = route($controllerName . '/' . $fieldName, [$fieldName => 'value_new', 'id' => $id]);
        $tmplDisplay = $valArr;
    ...
    public static function showItemBackground($controllerName, $thumbName)
    {
        $xhtml = asset("images/$controllerName/$thumbName");
        return $xhtml;
    }

    public static function showButtonAction($controllerName, $id)
    {
        $tmplButton   = Config::get('coffee.template.button');
        $buttonInArea = Config::get('coffee.config.button');
    ...
    {
        return date_format(date_create($dateTime), Config::get('coffee.format.short_time'));
    }
