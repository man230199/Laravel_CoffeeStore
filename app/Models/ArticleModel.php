...
class ArticleModel extends AdminModel
{
    ...
    public function listItems($params = null, $options = null)
    {
        ...
        if ($options['task'] == "admin-list-items") {
            $query = $this->select('a.id', 'a.name', 'a.short_content','a.status', 'a.content', 'a.thumb', 'a.type','c.id as category_id' ,'a.category_article_id as category_article_id','c.name as category_name','c.parent_id','c._lft','c._rgt')
            ...
            if(isset($params['category_article_id'])) {
                $query->where('a.category_article_id', $params['category_article_id']);
            }
