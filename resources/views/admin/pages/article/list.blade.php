                ...
                @if (count($items) > 0)
                    @foreach ($items as $key => $val)
                        @php
                            ...
                            $shortContent         = Hightlight::show($val['short_content'], $params['search'], 'short_content');
                            $thumb           = Template::showItemThumb($controllerName, $val['thumb'], $val['name']);
                           // $categoryName    = $val['category_name'];
                            $categoryName    = Template::showCustomItemSelect($controllerName, $id, $val['category_article_id'],'category',$categories);
